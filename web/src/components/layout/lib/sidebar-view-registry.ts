 ...
 *
 * System Settings sections are surfaced directly in the admin panel root nav
 * (see `use-sidebar-data`), so no nested
 * view should replace the sidebar there. Kept as an extension point for future
 * drill-in workspaces.
 */
